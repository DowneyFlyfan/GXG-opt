...
def test_comparison_records_uses_each_selected_baseline_accumulation(tmp_path):
    import json

    from gn_experiment import _comparison_records
    ...
    records = _comparison_records(tmp_path, "muown")

    assert records[0]["step"] == 2035
