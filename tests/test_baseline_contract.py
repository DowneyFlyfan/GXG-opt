...
def test_labelled_trial_artifacts_preserve_the_retained_baseline_paths(tmp_path):
    ...
    assert retained.checkpoint == tmp_path / ".cache/nlp/checkpoints/nlp_gpt_12x512__muon.checkpoint.pt"
    assert literature.checkpoint == (
        tmp_path
        / ".cache/nlp/checkpoints/nlp_gpt_12x512__literature_lr005_eff48__muon.checkpoint.pt"
    )
