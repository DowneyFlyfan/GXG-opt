...
- adamw: AdamW lr=0.0003 (full), final validation accuracy 0.721696.
...
- `results/nlp/nlp_gpt_12x512_literature_lr_tuning_metric_steps.png`
- `results/nlp/nlp_gpt_12x512_literature_lr_tuning_metric_time.png`
