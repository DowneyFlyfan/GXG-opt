...
from lr_tuning_plot import (
    ...
    write_selected_baseline_alias_plots,
...
def write_literature_tuning_summary(root: Path) -> Path:
    ...
    write_selected_baseline_alias_plots(root)
    lines = [
        ...
        "- Final-baseline figures use the best completed fixed-batch sweep runs: AdamW lr=0.00015 and Muon lr=0.0025.",
        "",
