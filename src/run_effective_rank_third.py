"""Run matched GPT2-12x512 effective-rank-third certified trials."""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Run matched GPT2-12x512 effective-rank-third certification"
    )
